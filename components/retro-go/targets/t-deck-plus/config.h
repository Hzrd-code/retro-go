...
#define T_DECK_KBD_ADDRESS          0x55 // Standard T-Deck (was 0x20 for Plus)
#define T_DECK_KBD_MODE_RAW_CMD     0x03 // Standard T-Deck (was 0x00 for Plus)

// Touch & Keypad Reset Pin (removed for standard T-Deck)
